...
from pore2tree.utils.seq_utils import is_dna

from pore2tree.wrappers import WrapperError
from pore2tree.wrappers.aligners.base_aligner import identify_input
...
class TreeBuilder(object):
    """
    Base class for wrappers of tree building software

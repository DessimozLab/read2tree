...
#$ -N r2t_{species_id}
#$ -wd /home/ddylus/research/david_dylus/avian/sge_output/
reads=/home/ddylus/research/david_dylus/avian/reads/{species_id}
cd /home/ddylus/research/david_dylus/avian/r2t/
source activate r2t
if [ -s $reads/{species_id}\_1.fa ] && [ -s $reads/{species_id}\_2.fa ]
then
    python -W ignore /home/ddylus/opt/read2tree/bin/read2tree \
--reads $reads/{species_id}_1.fa $reads/{species_id}_2.fa \
--output_path /home/ddylus/research/david_dylus/avian/r2t/ --single_mapping {reference} \
...
#$ -wd /home/ddylus/research/david_dylus/avian/sge_output/
rm -r \
/home/ddylus/research/david_dylus/avian/reads/{species_id}""".format(species_id=species_id)

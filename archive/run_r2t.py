...
# --step 2map --standalone_path marker_genes  --dna_reference dna_ref.fa --reads 100kreads.fq  --output_path output --debug --threads 1
...
# --step 2map --standalone_path marker_genes  --dna_reference dna_ref.fa --reads /work/FAC/FBM/DBC/cdessim2/read2tree/bees2024/Mellifera_HostReads_ForSina/DNA64_1_R1_hostreads.fq.gz /work/FAC/FBM/DBC/cdessim2/read2tree/bees2024/Mellifera_HostReads_ForSina/DNA64_1_R2_hostreads.fq.gz --output_path output --debug --threads 1   --sc_threshold 0.001
# --step 2map --standalone_path marker_genes  --dna_reference dna_ref.fa --reads /work/FAC/FBM/DBC/cdessim2/read2tree/v2_test/t1/reads_20/ERR7350657__2.fastq.gz  --output_path output --debug --threads 1

# --step 3combine --standalone_path marker_genes  --dna_reference dna_ref.fa  --output_path output   --debug

#--step 3combine --standalone_path /work/FAC/FBM/DBC/cdessim2/read2tree/metagenomics/Jan2025/run1//marker_genes  --dna_reference /work/FAC/FBM/DBC/cdessim2/read2tree/metagenomics/Jan2025/run1//dna_ref.fa  --output_path /work/FAC/FBM/DBC/cdessim2/read2tree/metagenomics/Jan2025/run1/output   --debug


# --step 2map --standalone_path marker_genes  --dna_reference dna_ref.fa --reads 100kreads.fq  --output_path output --debug --threads 1
# /work/FAC/FBM/DBC/cdessim2/read2tree/bees2024/t4

#  read2tree  --step 2map --standalone_path marker_genes  --dna_reference dna_ref.fa --reads /work/FAC/FBM/DBC/cdessim2/read2tree/bees2024/Mellifera_HostReads_ForSina/64_1_R1_hostreads.fq.gz /work/FAC/FBM/DBC/cdessim2/read2tree/bees2024/Mellifera_HostReads_ForSina/64_1_R2_hostreads.fq.gz --output_path output --debug --threads 1   --sc_threshold 0.001
a=1
...
#     print("there are ", len(species_name_all), format_input, " files, and the first file has ", len(fa_all[0]),
#           "sequences in it.")  # , sum([len(i) for i in og_all]
#
...
#             fiveLetter_species = species_name.split(".")[0].split("_")[1][
#                                  -5:]  # GCA_000849305.1_ViralProj14697_translated_cds.faa  # JN032115.1_cds_from_genomic.fna
#         fiveLetter_species_dic[species_name] = fiveLetter_species
#     except:
#         fiveLetter_species_dic = {}
#
...
#
#     input_folder_faa = "test1/input_faa/" #sys.argv[1] + "/"  # "data/"
#
#     output_folder_faa = "test1/DB/" # sys.argv[2] + "/"  # "DB/"
#     output_file_fna = "all_cdna_out.fa" #sys.argv[3]  # "all_cdna.fa"
#
...
#
#
#     assert len(species_name_all_faa) == len(
#         species_name_all_fna), "the number of faa and fna files should be the same in the folder."
#
...
#     assert len(all_prot_fna_recordid) == len(
#         all_prot_fna_id_set), "all record id in fna files should be unique. we consider this format when we checl" + \
#                               all_prot_fna_recordid[0]
#
